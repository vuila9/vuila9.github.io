function Calendar_date_teller() {
    ...
    function CDT_note() {
        const CDT_note = document.getElementById('CDT-note');
        CDT_note.title = `This tool was developed using manually built functions, without utilizing any built-in date manipulation functions, except for one to obtain the current date. The result will include the ending date.`
    }
    CDT_note();
}
